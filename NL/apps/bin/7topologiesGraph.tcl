...
#Open the NAM trace file set nf [open exp7.nam w]
$ns namtrace-all $nf

#Open the Trace file set tf [open exp7.tr w]
$ns trace-all $tf
...
#Execute NAM on the trace file exec nam exp7.nam &
exit 0
}

#Create four nodes set n0 [$ns node] set n1 [$ns node] set n2 [$ns node]
